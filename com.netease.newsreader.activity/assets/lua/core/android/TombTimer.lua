...
function setInterval(f,delay)
	...
	local	handlercls = luabridge.bindClass('com.netease.os.ColorUIHandler')
	local handler = handlercls["createNewHandler.(Ljava/lang/String;)Lcom/netease/os/ColorUIHandler;"](handlercls,lightappInfo.appName);
...
function setTimeout(f,delay)
	...
	if globalhandler ==nil then
		local	handlercls = luabridge.bindClass('com.netease.os.ColorUIHandler')
		globalhandler = handlercls["getInstanceHandler.(Ljava/lang/String;)Lcom/netease/os/ColorUIHandler;"](handlercls,lightappInfo.appName);
	end
	timer["runnable"] = luabridge.createSoftProxy('java.lang.Runnable',timer["uuid"],"time")	
