...
function CCBReaderLoad(strFilePath,proxy,bSetOwner,strOwnerName)
    ...
    if nil ~= owner then
        ...
        if nil == ownerCallbackNames then
            QZLOGINFO("ownerCallbackNames is nil")
            do return end
        elseif nil == ownerCallbackNodes then
            QZLOGINFO("ownerCallbackNodes is nil")
            do return end
        end
        ...
        if nil == ownerOutletNames then
            QZLOGINFO("ownerOutletNames is nil")
            do return end
        elseif nil == ownerOutletNodes then
            QZLOGINFO("ownerOutletNodes is nil")
            do return end
        end
    ...
    if nil == nodesWithAnimationManagers then
        QZLOGINFO("nodesWithAnimationManagers is nil")
        do return end
    elseif nil == animationManagersForNodes then
        QZLOGINFO("animationManagersForNodes is nil")
        do return end
    end
    ...
    for i = 1 , nodesWithAnimationManagers:count() do
        ...
        if nil == documentCallbackNames then
            QZLOGINFO("documentCallbackNames is nil")
            do return end
        elseif nil == documentCallbackNodes then
            QZLOGINFO("documentCallbackNodes is nil")
            do return end
        end
        ...
        if nil == documentOutletNames then
            QZLOGINFO("documentOutletNames is nil")
            do return end
        elseif nil == documentOutletNodes then
            QZLOGINFO("documentOutletNodes is nil")
            do return end
        end
        ...
        if nil == keyframeCallbacks then
            QZLOGINFO("keyframeCallbacks is nil")
            do return end
        end
